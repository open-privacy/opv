...
func (sq *ScopeQuery) QueryFacts() *FactQuery {
	query := &FactQuery{config: sq.config}
...
// Returns a *NotSingularError when exactly one Scope entity is not found.
...
func (sq *ScopeQuery) Clone() *ScopeQuery {
	...
	return &ScopeQuery{
		...
		predicates: append([]predicate.Scope{}, sq.predicates...),
		withFacts:  sq.withFacts.Clone(),
...
func (sq *ScopeQuery) GroupBy(field string, fields ...string) *ScopeGroupBy {
	group := &ScopeGroupBy{config: sq.config}
...
func (sq *ScopeQuery) Select(field string, fields ...string) *ScopeSelect {
	...
	return &ScopeSelect{ScopeQuery: sq}
}

func (sq *ScopeQuery) prepareQuery(ctx context.Context) error {
...
func (sq *ScopeQuery) sqlAll(ctx context.Context) ([]*Scope, error) {
	var (
		nodes       = []*Scope{}
		_spec       = sq.querySpec()
		loadedTypes = [1]bool{
	...
	if query := sq.withFacts; query != nil {
		...
		query.Where(predicate.Fact(func(s *sql.Selector) {
			s.Where(sql.InValues(scope.FactsColumn, fks...))
		}))
		...
		for _, n := range neighbors {
			fk := n.scope_facts
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "scope_facts" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "scope_facts" returned %v for node %v`, *fk, n.ID)
			}
...
func (sq *ScopeQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := sq.querySpec()
...
func (sq *ScopeQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if ps := sq.order; len(ps) > 0 {
		_spec.Order = func(selector *sql.Selector) {
			for i := range ps {
				ps[i](selector, scope.ValidColumn)
			}
		}
	}
	return _spec
...
func (sq *ScopeQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(sq.driver.Dialect())
	t1 := builder.Table(scope.Table)
	selector := builder.Select(t1.Columns(scope.Columns...)...).From(t1)
	if sq.sql != nil {
		selector = sq.sql
		selector.Select(selector.Columns(scope.Columns...)...)
	}
	for _, p := range sq.predicates {
		p(selector)
	}
	for _, p := range sq.order {
		p(selector, scope.ValidColumn)
	}
	if offset := sq.offset; offset != nil {
...
func (sgb *ScopeGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScopeGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScopeGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScopeGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScopeGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScopeGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScopeGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScopeGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScopeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScopeGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("ent: ScopeGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *ScopeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *ScopeGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (sgb *ScopeGroupBy) sqlQuery() *sql.Selector {
	selector := sgb.sql
	columns := make([]string, 0, len(sgb.fields)+len(sgb.fns))
	columns = append(columns, sgb.fields...)
	for _, fn := range sgb.fns {
		columns = append(columns, fn(selector, scope.ValidColumn))
	}
...
func (ss *ScopeSelect) Scan(ctx context.Context, v interface{}) error {
	...
	ss.sql = ss.ScopeQuery.sqlQuery(ctx)
...
func (ss *ScopeSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScopeSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScopeSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScopeSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScopeSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScopeSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScopeSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScopeSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScopeSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScopeSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("ent: ScopeSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *ScopeSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{scope.Label}
	default:
		err = fmt.Errorf("ent: ScopeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *ScopeSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
...
func (ss *ScopeSelect) sqlQuery() sql.Querier {
	selector := ss.sql
