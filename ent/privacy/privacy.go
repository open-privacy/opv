...
import (
	...
	"github.com/open-privacy-vault/opv/ent"
...
func (f FactQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.FactQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.FactQuery", q)
}

// The FactMutationRuleFunc type is an adapter to allow the use of ordinary
...
func (f FactMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.FactMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.FactMutation", m)
}

// The FactTypeQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
...
func (f FactTypeQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.FactTypeQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.FactTypeQuery", q)
}

// The FactTypeMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
...
func (f FactTypeMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.FactTypeMutation); ok {
		return f(ctx, m)
	}
